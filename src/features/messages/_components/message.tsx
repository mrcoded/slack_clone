...
import { useUpdateMessage } from "@/features/messages/actions/update-message";
import { useRemoveMessage } from "@/features/messages/actions/remove-message";
import { useToggleReaction } from "@/features/reactions/actions/toggle-reaction";
...
const Renderer = dynamic(
  () => import("@/features/messages/_components/renderer"),
  {
    ssr: false,
  }
);
